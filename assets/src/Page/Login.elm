...
type Msg
    ...
    | Submit
    | GotLoginResponse (Result String Effect.AuthResponse)
...
update shared msg model =
    case msg of
        ...
        GotLoginResponse result ->
            case result of
                Ok response ->
                    -- Login successful - navigation and token saving will be handled by Main
...
save model shared =
    -- Nothing to save for login page
    shared
...
load shared model =
    -- Nothing to load for login page
    model
